...
TRANSLATIONS = {
    ...
    'zh-HK': {
        ...
        # Auth - Login
        'welcome_back': '歡迎回來！',
        'welcome_back_desc': '好開心再見到你。登入以繼續你的旅程。',
        'friendly_conversations': '友善對話',
        'voice_support': '語音支援',
        'personalized_care': '個人化關懷',
        'sign_in': '登入',
        'sign_in_desc': '請輸入你的資料以繼續',
        'forgot_password': '忘記密碼？',
        'need_help_title': '需要幫助？',
        'need_help_desc': '如果登入有問題，請聯絡我們的支援團隊。我們隨時為您服務。',
        'show_password': '顯示密碼',

        # Auth - Register
        'join_community': '加入我們！',
        'join_community_desc': '建立帳戶開始你的旅程，只需一會！',
        'safe_secure': '安全可靠',
        'supportive_community': '互助社群',
        'easy_to_use': '容易使用',
        'register_title': '註冊',
        'register_desc': '請填寫你的資料以開始',
        'password_hint': '至少使用8個字符，包含字母和數字',
        'privacy_title': '您的隱私很重要',
        'privacy_desc': '我們保護您的個人資料，絕不會未經許可而分享。',
        ...
        'no_speech_support': '你的瀏覽器不支援語音辨識，請使用 Chrome 或 Edge。',
        'no_speech_detected': '未偵測到語音，請再試一次。',
        'mic_denied': '麥克風權限被拒絕，請檢查瀏覽器設定。',
        'processing': '處理音訊中...',
        'chat_cleared': '對話已清除',
        'tts_on': '語音朗讀已開啟',
        'tts_off': '語音朗讀已關閉',
        'page_loaded': '頁面已載入。準備好傾偈。',
        'you': '你',
    }
}
