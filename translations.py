...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        'guide_chat_desc': 'Type a message or press the microphone button to talk. The AI companion will reply warmly.',
        ...
        'guide_search_desc': 'Click the search button to let AI search the internet for answers.',
        'guide_upload_title': 'Upload Files',
        'guide_upload_desc': 'Click the upload button to share images or documents with the AI.',
        ...
        'speak': 'Speak',
        'listen_ai': 'Listen to AI',
        'ai_voice_on': '🔊 AI Voice: ON',
        'ai_voice_off': '🔇 AI Voice: OFF',
    ...
    'zh-HK': {
        ...
        'guide_close': '關閉',
        'guide_chat_title': '傾偈',
        'guide_chat_desc': '打字或者撳咪高峰按鈕講嘢，AI夥伴會溫暖咁回覆你。',
        ...
        'guide_search_desc': '撳搜尋按鈕，等AI幫你喺網上搵答案。',
        'guide_upload_title': '上傳檔案',
        'guide_upload_desc': '撳上傳按鈕，分享圖片或者文件畀AI睇。',
        ...
        'ai_voice_on': '🔊 AI語音：開',
        'ai_voice_off': '🔇 AI語音：關',
        'welcome_chat': '你好！我係嘉欣。請問你今日過得點呀？😊',
        'no_speech_support': '你的瀏覽器唔支援語音辨識，請用 Chrome 或 Edge。',
