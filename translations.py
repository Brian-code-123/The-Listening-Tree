...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        'email_invalid': 'Please enter a valid email first',
        ...
        'checkin_morning': 'Good morning! How did you sleep? Have you had breakfast yet? ☀️',
        'checkin_afternoon': 'Good afternoon! How has your day been so far? Have you had lunch? 🌤️',
        'checkin_evening': 'Good evening! How are you feeling today? Did you have dinner? 🌙',
        'reminder_daily': 'Repeat every day',
        ...
        'hk_guide_last_updated': 'Last updated:',
    ...
    'zh-HK': {
        ...
        'accessibility_desc': '此頁為視力不佳的長者特別優化',
        ...
        'guide_close': '關閉',
        'guide_chat_title': '聊天',
        'guide_chat_desc': '輸入訊息或按下麥克風按鈕說話，我們會溫暖地回覆您。',
        'guide_voice_title': '語音輸入',
        'guide_voice_desc': '按下麥克風按鈕，清楚地說話，您說的話會自動轉換成文字。',
        'guide_reminder_title': '設置提醒',
        'guide_reminder_desc': '輸入「設置提醒 食藥 09:00」或使用右邊的提醒面板。',
        'guide_game_title': '玩遊戲',
        'guide_game_desc': '輸入「玩遊戲」開始有趣的問答。答對每條問題即可得分！',
        'guide_search_title': '網頁搜尋',
        'guide_search_desc': '按下搜尋按鈕，讓我們幫您在網上尋找答案。',
        'guide_upload_title': '上傳檔案',
        'guide_upload_desc': '按下上傳按鈕，分享圖片或文件給我們看。',
        'guide_theme_title': '切換主題',
        'guide_theme_desc': '按下太陽/月亮圖示切換光亮與深暗模式。',
        'guide_lang_title': '轉換語言',
        'guide_lang_desc': '按下 EN 或 繁中 切換語言。每個語言的對話記錄會分開保存。',
        ...
        # Error messages
        'error_generic': '發生了一些問題。請再試一次。',
        'error_voice': '無法使用麥克風。請檢查權限設定。',
        'error_network': '網絡錯誤。請檢查您的連線。',

        # Auth - Login
        'welcome_back': '歡迎回來！',
        'welcome_back_desc': '很高興再見到您。請登入以繼續您的旅程。',
        ...
        # Auth - Register
        'join_community': '加入我們！',
        'join_community_desc': '建立帳戶開始您的旅程，只需片刻！',
        'safe_secure': '安全可靠',
        'supportive_community': '互助社群',
        'easy_to_use': '容易使用',
        'register_title': '註冊',
        'register_desc': '請填寫您的詳細資料以開始',
        'password_hint': '至少使用8個字符，包含字母與數字',
        'verification_code': '驗證碼',
        'send_code': '發送驗證碼',
        'code_sent': '驗證碼已發送',
        'sending_code': '發送緊...',
        'email_invalid': '請先輸入有效電郵地址',
        'network_error': '網絡錯誤，請再試一次',
        'privacy_title': '您的隱私非常重要',
        'privacy_desc': '我們保護您的個人資料，絕對不會未經許可分享。',
        ...
        'chat_messages': '對話訊息',
        'assistant': '助手',
        'welcome_message': '你好！我有什麼可以幫到您？您可以輸入訊息或使用語音輸入。',
        'just_now': '剛才',
        'type_here': '在這裡輸入您的訊息...',
        'message_input': '訊息輸入欄',
        'send_message': '發送訊息',
        ...
        'stop_recording': '停止錄音',
        'stop': '停止',
        'discard_recording': '捨棄錄音',
        'toggle_speech': '切換語音朗讀',
        'speak': '朗讀',
        'listen_msg': '聽取回覆',
        'voice_on': '🔊 語音：開啟',
        'voice_off': '🔇 語音：關閉',
        'welcome_chat': '您好！我是陪伴您的好朋友，今天過得怎麼樣呢？😊',
        'checkin_morning': '早晨！琴晚瞓得好唔好呀？食咗早餐未？☀️',
        'checkin_afternoon': '午安！今日過得點呀？食咗午飯未？🌤️',
        'checkin_evening': '晚安！今日感覺點呀？食咗晚飯未？🌙',
        'reminder_daily': '每日重複',
        'no_speech_support': '您的瀏覽器不支持語音辨識，請使用 Chrome 或 Edge。',
        'no_speech_detected': '未能偵測到語音，請再試一次。',
        'mic_denied': '麥克風權限被拒絕，請檢查瀏覽器設定。',
        'processing': '正在處理音訊...',
        'chat_cleared': '對話已清除',
        'tts_on': '語音朗讀已開啟',
        'tts_off': '語音朗讀已關閉',
        'page_loaded': '頁面已載入。準備好聊天了。',
        'you': '您',
        ...
        'searching': '正在搜尋網頁...',
        'uploading': '正在上傳檔案...',
        'file_too_large': '檔案太大。最高限制10MB。',
        'unsupported_file': '不支持此類檔案類型。',
        'search_enabled': '此訊息已啟用網頁搜尋',
        ...
        'hk_guide_fun': '玩樂景點',
        'hk_guide_events': '活動',
        'hk_guide_loading': '正在載入最新資訊...',
        'hk_guide_last_updated': '最後更新：',
        'hk_guide_empty': '此分類暫時沒有項目。',
        'hk_guide_nav': '香港攻略',
    },
}
